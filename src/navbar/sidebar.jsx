...
>>>>>>> b327d384df1f2cd03f159b0055d8b2e218d892a7
// import {
//   Home,
//   Briefcase,
//   ChevronRight,
    ...
    <X size={24} className="text-gray-600" />
      ...
      <nav className="flex flex-col space-y-2">
        ...
        >
          ...
          <ChevronRight size={18} className={`ml-auto transition-transform duration-300 ${showHRM ? "rotate-90" : ""}`} />
        </button>
        ...
        >
          ...
          <ChevronRight size={18} className={`ml-auto transition-transform duration-300 ${proposal ? "rotate-90" : ""}`} />
        </button>

        {proposal && (
          <>
            <Link to="/proposal" className="flex ml-2 text-sm items-center space-x-3 p-3 rounded-lg hover:text-[#008ECC]">
              <div className="bg-white p-1 rounded-[12px] shadow-md" />
              <span>Proposal list</span>
            </Link>
            <Link to="/template" className="flex ml-2 text-sm items-center space-x-3 p-3 rounded-lg hover:text-[#008ECC]">
              <div className="bg-white p-1 rounded-[12px] shadow-md" />
              <span>Templates</span>
            </Link>
          </>
        ...
        >
          ...
          <ChevronRight size={18} className={`ml-auto transition-transform duration-300 ${showHRMSystem ? "rotate-90" : ""}`} />
        </button>
        ...
        >
          ...
          <ChevronRight size={18} className={`ml-auto transition-transform duration-300 ${showUserManagement ? "rotate-90" : ""}`} />
        </button>
        ...
        {showUserManagement && (
          <>
            ...
            <Link to="/LostReasons" className="flex ml-2 text-sm items-center space-x-3 p-3 rounded-lg hover:text-[#008ECC]">
              <div className="bg-white p-1 rounded-[12px] shadow-md" />
              <span>Lost reasons</span>
            </Link>
          </>
        ...
        >
          ...
          <ChevronRight size={18} className={`ml-auto transition-transform duration-300 ${activities ? "rotate-90" : ""}`} />
        </button>
        ...
        >
          ...
          <ChevronRight size={18} className={`ml-auto transition-transform duration-300 ${reports ? "rotate-90" : ""}`} />
        </button>
...
<Link to="/invoice">
        ...
        {/* Users & Roles */}
        <Link to="/user/roles" className="flex items-center justify-between p-3 rounded-lg font-semibold hover:bg-[#008ECC] hover:shadow-[0_4px_10px_0_#99c7db] hover:text-white text-gray-700">
          <div className="flex items-center space-x-3 text-sm font-semibold">
            <div className="bg-white p-1 rounded-[12px] shadow-md text-gray-500">
              <Shield size={20} />
            </div>
