...
export default function AddUserModal({ onUserCreated }) {
  ...
  const handleChange = (e) => {
    ...
    // Real-time password match validation (FIXED)
  ...
  const validatePhoneNumber = (phoneNumber) => {
    ...
    // Check valid international format
