...
// /* ── Number formatter: clamp to max digits, never overflow ── */
// const fmt = (n) =>
...
//       {/* Table — inner scrollbar stays within page */}
...
//       {/* ══════════════════════════════════════════════════════════════
//           CONVERT MODAL — FIXED OVERFLOW + NEW FIELDS
//           ══════════════════════════════════════════════════════════════ */}
//       <Dialog open={convertModalOpen} onOpenChange={setConvertModalOpen}>
...
//                     <Users size={12} /> No. of Travellers
//                   </label>
//                   <input
//                     type="number"
//                     min="1"
//                     value={dealData.noOfTravellers}
//                     onChange={(e) => setDealData((p) => ({ ...p, noOfTravellers: e.target.value }))}
//                     placeholder="e.g. 2"
//                     className="w-full px-3 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-400 focus:outline-none"
//                   />
//                 </div>
