        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-10">
                    ...
                    {field.name === "phoneNumber" ? (
                      ...
                      <div className="relative w-full">
                        ...
                        <textarea
                          ...
                          className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-300 bg-white shadow-sm text-sm text-gray-700   placeholder-gray-400 transition resize-none"
                        />
          ...
          <div className="p-6 border rounded-2xl shadow-sm bg-white">
            ...
            <div className="mt-4">
              <label
                htmlFor="attachments"
                className="flex flex-col items-center justify-center w-full min-h-32 border-2 border-dashed border-indigo-300 rounded-xl cursor-pointer hover:border-indigo-500 hover:bg-indigo-50 transition p-4"
              >
                {formData.attachments.length === 0 ? (
                  ...
                  <div className="w-full flex flex-wrap gap-4">
                    {formData.attachments.map((file, idx) => (
                      <div
                        key={idx}
                        className="flex flex-col items-center justify-center w-28 h-28 bg-gray-50 border rounded-xl shadow-sm"
                      >
                        {/* File Icon */}
                        <div className="w-12 h-12 flex items-center justify-center bg-gray-200 rounded-md mb-1">
                        ...
                        <button
                          ...
                          className="text-[15px] text-red-600 hover:underline mt-1"
                        >
                          Remove file
                        </button>
                      </div>
