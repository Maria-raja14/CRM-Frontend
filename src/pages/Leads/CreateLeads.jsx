...
//     const patterns = {
//       in: /^(\+91|0)?[6-9]\d{9}$/, // India: 10 digits starting with 6-9
//       us: /^(\+1)?[2-9]\d{9}$/, // US: 10 digits, first digit 2-9
//       gb: /^(\+44|0)?[1-9]\d{9}$/, // UK: 10 digits
//       ca: /^(\+1)?[2-9]\d{9}$/, // Canada: similar to US
//       au: /^(\+61|0)?[2-9]\d{8}$/, // Australia: 9 digits
//       de: /^(\+49|0)?[1-9]\d{10}$/, // Germany: 11 digits
//       fr: /^(\+33|0)?[1-9]\d{8}$/, // France: 9 digits
//       jp: /^(\+81|0)?[1-9]\d{8,9}$/, // Japan: 9-10 digits
//       cn: /^(\+86|0)?[1-9]\d{9,10}$/, // China: 10-11 digits
//       br: /^(\+55|0)?[1-9]\d{10,11}$/, // Brazil: 11 digits
//       ru: /^(\+7|8)?[1-9]\d{9,10}$/, // Russia: 10-11 digits
//     };

//     // Get pattern for selected country or use default validation
//     const pattern = patterns[countryCode] || /^(\+\d{1,3})?\d{8,15}$/;
