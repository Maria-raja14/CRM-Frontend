        ...
        <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100 items-center justify-center p-8">
          <div className="text-center">
            ...
            <p className="text-gray-600 mt-3">
              Customer Relationship Management system used for managing
              leads, deals, proposals and communication.
            </p>
        ...
        <div className="flex flex-col justify-center w-full lg:w-1/2 p-8 lg:p-12">
          ...
          <div className="mb-6 lg:hidden flex flex-col items-center">
            <img
              ...
              className="w-28 mb-3"
            />
            <h1 className="text-xl font-bold">UEnjoyTours CRM</h1>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleLogin}>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full text-white py-3 rounded-lg font-medium hover:bg-blue-700"
              style={{ backgroundColor: "#008ECC" }}
            >
          ...
          <div className="mt-8 text-center text-sm text-gray-600">
            ...
            <p className="mt-3 text-gray-500">
              © 2025 UEnjoyTours CRM. All rights reserved.
            </p>
          </div>
        </div>
      </div>
