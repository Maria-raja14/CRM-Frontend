...
const Login = () => {
  ...
  // ✅ Open modals via global events (handled in App.jsx)
  const openPrivacy = () => window.dispatchEvent(new Event("open-privacy"));
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="flex flex-col lg:flex-row w-full max-w-4xl bg-white rounded-2xl shadow-2xl overflow-hidden">
        ...
        {/* ── Right Side — Login Form ── */}
        <div className="flex flex-col justify-between w-full lg:w-1/2 p-8 lg:p-12">
          ...
          <div className="mt-8 text-center space-y-2">
            {/* ✅ Privacy Policy & Terms links — open modals, no page navigation */}
