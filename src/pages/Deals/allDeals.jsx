...
//         toast.error("You don't have permission to view deals");
//       } else {
//         toast.error("Failed to fetch deals");
//       }
//       console.error(err);
...
//   // Fetch sales users for dropdown in edit modal - only for admins
//   const fetchUsers = async () => {
//     try {
//       const token = localStorage.getItem("token");
//       const res = await axios.get("http://localhost:5000/api/users", {
...
//     } catch (err) {
//       if (err.response?.status === 403) {
//         toast.error("You don't have permission to update this deal");
//       } else {
...
//     } catch (err) {
//       if (err.response?.status === 403) {
//         toast.error("You don't have permission to delete these deals");
//       } else {
...
//           <p className="text-blue-700">You are viewing only your assigned deals</p>
//         </div>
//       )}
