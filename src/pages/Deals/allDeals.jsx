...
// /* ── Cost helpers ─────────────────────────────────────── */
// const parseCost = (v) => parseFloat(String(v || "0").replace(/,/g, "")) || 0;

// const formatMoney = (v, currency = "INR") => {
//   const num = parseCost(v);
//   if (num === 0) return "-";
//   return `${new Intl.NumberFormat("en-IN", { minimumFractionDigits: 0 }).format(num)}`;
// };

// const getCurrency = (deal) => deal.currency || "INR";
...
//           <div className="w-10 h-10 rounded-full bg-orange-100 flex items-center justify-center text-orange-600 font-bold text-sm flex-shrink-0">P</div>
//           <div>
//             <p className="text-xs text-orange-600 font-medium">Total Purchasing Cost</p>
//             <p className="text-base font-bold text-orange-700">{new Intl.NumberFormat("en-IN").format(grandTotalPurchasing)}</p>
//           </div>
//         </div>
//         <div className="bg-green-50 border border-green-200 rounded-xl p-4 flex items-center gap-3">
//           <div className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center text-green-600 font-bold text-sm flex-shrink-0">S</div>
//           <div>
//             <p className="text-xs text-green-600 font-medium">Total Selling Cost</p>
//             <p className="text-base font-bold text-green-700">{new Intl.NumberFormat("en-IN").format(grandTotalSelling)}</p>
//           </div>
//         </div>
//         <div className={`${grandProfit >= 0 ? "bg-emerald-50 border-emerald-200" : "bg-red-50 border-red-200"} border rounded-xl p-4 flex items-center gap-3`}>
...
//           </div>
//           <div>
//             <p className={`text-xs font-medium ${grandProfit >= 0 ? "text-emerald-600" : "text-red-600"}`}>Net Profit / Loss</p>
...
//             <option value="">All Stages</option>
//             <option value="Qualification">Qualification</option><option value="Negotiation">Negotiation</option>
...
//               {/* Purchasing Cost columns */}
//               <th className="px-4 py-3 text-left font-semibold whitespace-nowrap bg-orange-50 text-orange-700 border-l border-orange-200">
//                 <div className="flex items-center gap-1">
//                   <span className="w-2 h-2 rounded-full bg-orange-400 inline-block"></span>
//                   Purch. Land
//                 </div>
//               </th>
//               <th className="px-4 py-3 text-left font-semibold whitespace-nowrap bg-orange-50 text-orange-700 border-r border-orange-200">
//                 <div className="flex items-center gap-1">
//                   <span className="w-2 h-2 rounded-full bg-orange-400 inline-block"></span>
//                   Purch. Ticket
//                 </div>
...
//               {/* Selling Cost columns */}
//               <th className="px-4 py-3 text-left font-semibold whitespace-nowrap bg-green-50 text-green-700 border-l border-green-200">
//                 <div className="flex items-center gap-1">
//                   <span className="w-2 h-2 rounded-full bg-green-400 inline-block"></span>
//                   Sell. Land
//                 </div>
//               </th>
//               <th className="px-4 py-3 text-left font-semibold whitespace-nowrap bg-green-50 text-green-700">
//                 <div className="flex items-center gap-1">
//                   <span className="w-2 h-2 rounded-full bg-green-400 inline-block"></span>
//                   Sell. Ticket
//                 </div>
...
//               {/* Profit / Loss */}
//               <th className="px-4 py-3 text-left font-semibold whitespace-nowrap border-l border-gray-300">Profit / Loss</th>
...
//                 const currency    = getCurrency(deal);
...
//                     {/* Purchasing columns */}
//                     <td className="px-4 py-3 bg-orange-50/40 border-l border-orange-100 text-orange-700">
//                       {purchLand > 0 ? <span className="font-medium">{new Intl.NumberFormat("en-IN").format(purchLand)}</span> : <span className="text-gray-300">—</span>}
//                     </td>
//                     <td className="px-4 py-3 bg-orange-50/40 border-r border-orange-100 text-orange-700">
//                       {purchTicket > 0 ? <span className="font-medium">{new Intl.NumberFormat("en-IN").format(purchTicket)}</span> : <span className="text-gray-300">—</span>}
//                     </td>

//                     {/* Selling columns */}
//                     <td className="px-4 py-3 bg-green-50/40 border-l border-green-100 text-green-700">
//                       {sellLand > 0 ? <span className="font-medium">{new Intl.NumberFormat("en-IN").format(sellLand)}</span> : <span className="text-gray-300">—</span>}
//                     </td>
//                     <td className="px-4 py-3 bg-green-50/40 text-green-700">
//                       {sellTicket > 0 ? <span className="font-medium">{new Intl.NumberFormat("en-IN").format(sellTicket)}</span> : <span className="text-gray-300">—</span>}
//                     </td>

//                     {/* Profit / Loss */}
//                     <td className="px-4 py-3 border-l border-gray-200">
//                       {(totalPurch > 0 || totalSell > 0) ? (
...
//                 <td className="px-4 py-3 bg-orange-100 border-l border-orange-200 text-orange-800">
//                   {new Intl.NumberFormat("en-IN").format(filteredDeals.reduce((a, d) => a + parseCost(d.purchasingLandCost), 0))}
//                 </td>
//                 <td className="px-4 py-3 bg-orange-100 border-r border-orange-200 text-orange-800">
//                   {new Intl.NumberFormat("en-IN").format(filteredDeals.reduce((a, d) => a + parseCost(d.purchasingTicketCost), 0))}
//                 </td>
//                 <td className="px-4 py-3 bg-green-100 border-l border-green-200 text-green-800">
//                   {new Intl.NumberFormat("en-IN").format(filteredDeals.reduce((a, d) => a + parseCost(d.sellingLandCost), 0))}
//                 </td>
//                 <td className="px-4 py-3 bg-green-100 text-green-800">
//                   {new Intl.NumberFormat("en-IN").format(filteredDeals.reduce((a, d) => a + parseCost(d.sellingTicketCost), 0))}
//                 </td>
//                 <td className={`px-4 py-3 border-l border-gray-300 ${grandProfit >= 0 ? "text-emerald-700" : "text-red-700"}`}>
//                   <div className="flex items-center gap-1">
...
//           </p>
//           <div className="flex items-center gap-1">
//             <button onClick={() => handlePageChange(1)} disabled={safePage === 1} title="First page"
