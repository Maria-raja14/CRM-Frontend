...
const OrganizationTable = ({ search ,setOrganizations ,organizations}) => {
  ...
  const fetchOrganizations = async () => {
    ...
    try {
      ...
      setOrganizations([...response.data]); 
      console.log("Fetched Organizations:", response.data); // Debugging
    } catch (error) {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md overflow-y-auto">
      ...
      <div className="">
        <table className="w-full min-w-[1000px] border-collapse border-gray-50 bg-white shadow">
          <thead>
            <tr className="bg-gray-200 text-gray-700">
              ...
              {/* <th className="p-3 text-left">Closed deals</th>
              <th className="p-3 text-left">Open deals</th> */}
              <th className="p-3 text-left">Address</th>
              <th className="p-3 text-left">Loan</th>
              <th className="p-3 text-left">AAs</th>
              <th className="p-3 text-left">Sites</th>
              <th className="p-3 text-left">Testing Vishnu</th>
              <th className="p-3 text-left">Kiona Lyons</th>
          ...
          <tbody>
            {paginatedOrganizations.length > 0 ? (
              paginatedOrganizations.map((org) => (
                <tr key={org._id} className="border-b border-gray-50 hover:bg-gray-100">
                  <th className="p-3 text-left">
                    <input
                      type="checkbox"
                      className="form-checkbox h-4 w-4 text-blue-600"
                  ...
                  <td className="p-3">
                    {org.addressDetails
                      ? `${org.addressDetails.area}, ${org.addressDetails.city}, ${org.addressDetails.state}, ${org.addressDetails.zipCode}, ${org.addressDetails.country}`
                      : "N/A"}
                  </td>
