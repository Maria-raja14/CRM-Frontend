...
//               file_picker_types: "image", // Allow only image file uploads
//               images_upload_url: "/upload-image", // Replace with your API endpoint for uploads
//               automatic_uploads: true,
//               images_upload_handler: (blobInfo, success, failure) => {
//                 const reader = new FileReader();
//                 reader.readAsDataURL(blobInfo.blob());
//                 reader.onload = () => success(reader.result);
//                 reader.onerror = (error) => failure("Image upload failed");
//               },
//             }}
//           />
//         </div>
//         {/* Buttons to insert predefined text into the editor */}
//         <div className="flex gap-2 justify-center items-center mt-4">
//           <button
//             onClick={() => insertText("{{App_Name}}")}
//             className="bg-[#4466f2] text-white p-1 rounded-sm px-3"
...
//         <div className="mt-10 flex gap-3 items-center">
//           <button className="bg-[#4466f2] text-white p-2 rounded-sm px-3">
//             Save as template
//           </button>
//           <button className="bg-[#4466f2] text-white p-2 rounded-sm px-3">
//             Save and send
