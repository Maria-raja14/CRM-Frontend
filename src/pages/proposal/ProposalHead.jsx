  ...
  useEffect(() => {
    const fetchProposals = async () => {
      ...
      try {
        ...
        const draftProposals = response.data.filter(
          (p) => p.status === "draft"
        );
        setDraftCount(draftProposals.length);
        setError("");
...
const openFollowUpDialog = (proposal) => {
  ...
  return (
    <div className="min-h-screen py-8 px-2 md:px-10">
      {/* Header */}
        ...
        <table className="min-w-full text-sm">
          <thead className="bg-gray-100">
            <tr>
              ...
              <th className="px-4 py-2 text-left">Deal Title</th>
            ...
            {currentPageProposals.length === 0 ? (
              ...
              currentPageProposals.map((proposal) => (
                <tr key={proposal._id} className="border-b">
                  ...
                  <td className="px-4 py-2">{proposal.dealTitle}</td>
                  <td className="px-4 py-2">{proposal.email}</td>
                  ...
                  <td className="px-4 py-2 relative">
                    ...
                    {openActionId === proposal._id && (
                      <div className="absolute bg-white shadow rounded right-0 mt-1">
                        <button
                          onClick={() =>
                        ...
                        <button
                          ...
                          className="block px-3 py-1 w-full text-left text-red-600 hover:bg-gray-100"
                        >
                          Delete
                        </button>
                      </div>
