...
//   { selector: ".tour-actions",        content: "Access options like viewing, editing, or deleting a proposal." },
//   { selector: ".tour-finish",         content: "You've completed the tour! Click 'Take Tour' anytime to review features again." },
// ];

// /* ─── Delete Confirmation Modal ────────────────────────────────────── */
// const DeleteModal = ({ proposal, onCancel, onConfirm }) => (
//   <div
//     style={{
...
//   const [deleteTarget,       setDeleteTarget]       = useState(null); // proposal to delete
...
//       if (newStatus === "draft") setDraftCount((n) => n + 1);
//       else {
//         const old = proposals.find((p) => p._id === id);
//         if (old?.status === "draft") setDraftCount((n) => n - 1);
//       }
...
//       (p.createdAt && new Date(p.createdAt).toLocaleDateString() === new Date(filterCreatedDate).toLocaleDateString());
...
//             <tbody>
//               {paginated.length === 0 ? (
//                 <tr><td colSpan="5" className="text-center py-4 text-gray-400">No proposals found</td></tr>
//               ) : (
//                 paginated.map((proposal) => (
//                   <tr key={proposal._id} className="border-b hover:bg-gray-50 transition">
...
//                       <button onClick={(e) => openDropdown(proposal._id, e)} className="p-1">
//                         <BsThreeDotsVertical />
//                       </button>

//                       {openActionId === proposal._id && ReactDOM.createPortal(
//                         <div
//                           ref={dropdownRef}
//                           className="absolute bg-white shadow-lg rounded-lg border z-50 min-w-[130px] py-1"
//                           style={{ top: dropdownPosition.top, left: dropdownPosition.left }}
//                         >
//                           <button
//                             onClick={() => { setOpenActionId(null); navigate(`/proposal/view/${proposal._id}`); }}
//                             className="block px-4 py-2 w-full text-left hover:bg-gray-50 text-gray-700 text-sm"
//                           >
//                             👁 View
//                           </button>
//                           <button
//                             onClick={() => handleEdit(proposal._id)}
//                             className="block px-4 py-2 w-full text-left hover:bg-blue-50 text-blue-600 text-sm"
//                           >
//                             ✏️ Edit
//                           </button>
//                           <div style={{ height: 1, background: "#f1f5f9", margin: "2px 0" }} />
//                           <button
//                             onClick={() => { setOpenActionId(null); setDeleteTarget(proposal); }}
//                             className="block px-4 py-2 w-full text-left hover:bg-red-50 text-red-600 text-sm"
//                           >
//                             🗑 Delete
//                           </button>
//                         </div>,
...
//             className={`px-3 py-1.5 rounded-lg border text-sm transition ${currentPage === 1 ? "bg-gray-100 text-gray-400 cursor-not-allowed" : "bg-white text-gray-700 hover:bg-gray-50 border-gray-300"}`}
//           >Prev</button>

//           {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
//             <button key={page} onClick={() => setCurrentPage(page)}
//               className={`px-3 py-1.5 rounded-lg text-sm transition ${currentPage === page ? "bg-blue-600 text-white font-medium shadow-sm" : "bg-white border border-gray-300 text-gray-700 hover:bg-gray-50"}`}>
//               {page}
//             </button>
//           ))}
...
//             className={`px-3 py-1.5 rounded-lg border text-sm transition ${currentPage === totalPages ? "bg-gray-100 text-gray-400 cursor-not-allowed" : "bg-white text-gray-700 hover:bg-gray-50 border-gray-300"}`}
//           >Next</button>
//         </div>
//       )}
...
// export default ProposalHead;//original all work correctly..
