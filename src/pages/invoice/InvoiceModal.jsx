...
//   const calculateAmount = () => (Number(invoiceData.price) || 0).toFixed(2);
...
//                           <p className="mt-1 text-sm text-red-600 flex items-center gap-1">
//                             <span>⚠</span> {validationErrors.issueDate}
//                           </p>
//                         )}
//                       </div>
//                       <div>
...
//                           <p className="mt-1 text-sm text-red-600 flex items-center gap-1">
//                             <span>⚠</span> {validationErrors.dueDate}
//                           </p>
//                         )}
//                       </div>
//                     </div>
...
//                         <p className="mt-1 text-sm text-red-600 flex items-center gap-1">
//                           <span>⚠</span> {validationErrors.deal}
//                         </p>
//                       )}
//                     </div>
...
//                             <span className="font-semibold">Requirement:</span> {selectedDealRequirement.requirement}
//                           </p>
//                           <p className="text-sm text-green-700">
//                             <span className="font-semibold">Value:</span> Rs {selectedDealRequirement.value}
//                           </p>
//                         </div>
//                       </div>
//                     )}
...
//                           <p className="mt-1 text-sm text-red-600 flex items-center gap-1">
//                             <span>⚠</span> {validationErrors.price}
//                           </p>
//                         )}
//                       </div>
//                       <div>
...
//               <div className="mt-6 pt-4 border-t border-gray-200 flex justify-between items-start">
...
//                       </div>
//                       {invoiceData.currency === "INR" && invoiceData.taxType !== "none" && (
//                         <div className="flex justify-between gap-8 text-gray-700">
//                           <span>Tax:</span>
//                           <span>{breakdown.taxText} = Rs {breakdown.taxAmount}</span>
//                         </div>
//                       )}
//                       {invoiceData.discountType !== "none" && (
//                         <div className="flex justify-between gap-8 text-gray-700">
//                           <span>Discount:</span>
//                           <span>{breakdown.discountText} = Rs {breakdown.discountAmount}</span>
//                         </div>
//                       )}
//                       <div className="flex justify-between gap-8 font-bold text-blue-600">
//                         <span>Total:</span>
...
//             <div className="mb-6">
//               {!isNoteVisible ? (
//                 <button className="flex items-center text-blue-600 hover:text-blue-800 transition" onClick={handleAddNoteClick}>
...
//                       Notes
//                     </label>
//                     <button className="text-red-500 hover:text-red-700 text-sm flex items-center transition" onClick={handleRemoveNoteClick}>
//                       <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
//               <button
//                 className="px-5 py-3 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 focus:outline-none transition"
//                 type="button"
//                 onClick={closeModal}
//               >
//                 Cancel
//               </button>
//               <button
//                 className="px-5 py-3 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:outline-none transition flex items-center"
//                 type="button"
