          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 p-5">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                {/* Start Date */}
                <div className="flex items-center gap-2 bg-white border border-gray-300 rounded-lg px-3 py-2 hover:border-orange-400 transition-colors">
                  <FiCalendar className="text-gray-400 w-4 h-4" />
                  <input
                    type="date"
                    value={startDate}
                    onChange={(e) => setStartDate(e.target.value)}
                    className="bg-transparent border-none focus:outline-none text-gray-700 text-sm w-32"
                  />
                </div>
              ...
              {isAdmin && (
                <div className="relative ml-2">
                  ...
                  <input
                    ...
                    className="pl-9 pr-4 py-2 border border-gray-200 rounded-lg w-48 focus:ring-2 focus:ring-orange-500 focus:border-transparent text-sm"
                  />
                </div>
              )}
              <button
