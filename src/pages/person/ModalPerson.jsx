    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        if (person) {
          ...
          // Manually update the leadGroupId and organizationId after adding
          setFormData((prevFormData) => ({
            ...prevFormData,
            leadGroupId: updatedData.leadGroupId,
        ...
        console.error("Error saving person:", error);  // Log the full error object
        toast.error("Error saving person");
      } finally {
        setLoading(false); // Stop loading state after submission
      }
