  ...
  const ModalCalendar = ({ isOpen,onClose,activityToEdit,onactivityAdded,onEdit,}) => {
    ...
    const [formData, setFormData] = useState({
      activityCategory: "Call", title: "",description: "",activityType: "", activityModel: "", startDate: "", endDate: "",
      startTime: "",
      endTime: "",
      collaborators: [], 
      reminder: "", 
    ...
    const handleDateChange = (name, date) => {
      setFormData((prev) => ({
        ...prev,
        [name]: date, // Updates formData with selected date
      }));
    };
    const handleTimeChange = (name, time) => {
      setFormData((prev) => ({
        ...prev,
        [name]: time, // Updates formData with selected time
      }));
    };
      ...
      try {
        if (activityToEdit) {
            ...
            if (typeof onEdit === "function") {
              onEdit({ ...formData, _id: activityToEdit._id }); // make sure _id is retained
            }
          ...
          onactivityAdded(res.data.data); // ✅ Use `res.data.data`
          ...
          <div className="bg-white w-[900px] h-[600px] rounded-lg shadow-lg flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto p-8">
              <form onSubmit={handleSubmit}>
                ...
                <div className="flex items-center gap-38 mb-8">
                  <label className="text-gray-600 font-small">
                     Type
                  </label>
                  <select
                ...
                {formData.activityModel === "Deal" && (
                  <div className="flex items-center gap-38 mb-6">
                    <label className="text-gray-600">Deal</label>
                    <select
                      name="activityType" // ✅ Change to "activityType"
                      value={formData.activityType} // ✅ Correct value binding
                      onChange={handleInputChange}
